...
function Footer() {
  return (
        <View style={styles.footer}>
            ...
            <View style={{ padding:10,borderBottomWidth:3,borderBottomColor:'#69696B'}}>
            <Text style={styles.text} >Tải ứng dụng trên điện thoại</Text>
            <View style={{flexDirection:'row'}}>
            <Image source={require('../../assets/app-store.png')} style={styles.image} />
            <Image source={require('../../assets/google-play.png')} style={styles.image} />
            </View>
            </View>
            <View style={{padding:10}}>
                ...
                <Image source={require('../../assets/logoscada.png')} style={styles.imageLogo} />
