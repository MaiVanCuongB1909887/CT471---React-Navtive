...
const Home = ({navigation}) => {
  ...
  const renderProductItem2 = ({ item }) => (
    ...
    onPress={() =>
      ...
      <View
                ...
                {/* numberOfLines={1} */}
                <View>
                  <Text style={{fontSize: 20,width:100,color:'black'}} numberOfLines={1}>
                    {item.name}
                  </Text >
  ...
  return (
    ...
    {/* <List navigation={navigation}/> */}
      ...
      <View style={{margin:5,backgroundColor:'#e9edf2',padding:5,borderRadius:5}}>
          <Text style={{fontSize:20,fontWeight:'bold',color:'black',}}>Sản phẩm nổi bật</Text>
          </View>
      <FlatList
      key={'#'}
        data={products}
    ...
    <View>
      ...
      <View style={{margin:5,backgroundColor:'#e9edf2',padding:5,borderRadius:5}}>
          <Text style={{fontSize:20,fontWeight:'bold',color:'black',}}>Deal Sốc Mỗi Ngày</Text>
          </View>
          <FlatList
      key={'@'}
        data={products}
    ...
    <View>
    <View style={{margin:5,backgroundColor:'#e9edf2',padding:5,borderRadius:5}}>
          <Text style={{fontSize:20,fontWeight:'bold',color:'black',}}>Dành Cho Bạn Hôm Nay</Text>
          </View>
    <FlatList
      key={'!'}
        data={products}
      ...
      <View>
      <View style={{flexDirection:'row'}}>
      <View style={{height:100,width:'30%',margin:'1.5%',borderRadius:5,borderWidth:3 ,justifyContent:'center',alignItems:'center',borderColor:'#42454a'}}>
      <Image source={require('../../assets/cty1.jpg')} style={{height:'100%',width:'100%',resizeMode:'cover'}}/>
      </View>
      <View style={{height:100,width:'30%',margin:'1.5%',borderRadius:5,borderWidth:3,justifyContent:'center',alignItems:'center',borderColor:'#42454a'}}>
      <Image source={require('../../assets/cty2.jpg')} style={{height:'100%',width:'100%',resizeMode:'cover'}}/>
      </View>
      <View style={{height:100,width:'30%',margin:'1.5%',borderRadius:5,borderWidth:3,justifyContent:'center',alignItems:'center',borderColor:'#42454a'}}>
      <Image source={require('../../assets/cty3.jpg')} style={{height:'100%',width:'100%',resizeMode:'cover'}}/>
      </View>
      </View>
      <View style={{flexDirection:'row'}}>
      <View style={{height:100,width:'30%',margin:'1.5%',borderRadius:5,borderWidth:3,justifyContent:'center',alignItems:'center',borderColor:'#42454a'}}>
      <Image source={require('../../assets/cty4.jpg')} style={{height:'100%',width:'100%',resizeMode:'cover'}}/>
      </View>
      <View style={{height:100,width:'30%',margin:'1.5%',borderRadius:5,borderWidth:3,justifyContent:'center',alignItems:'center',borderColor:'#42454a'}}>
      <Image source={require('../../assets/cty5.jpg')} style={{height:'100%',width:'100%',resizeMode:'cover'}}/>
      </View>
      <View style={{height:100,width:'30%',margin:'1.5%',borderRadius:5,borderWidth:3,justifyContent:'center',alignItems:'center',borderColor:'#42454a'}}>
      <Image source={require('../../assets/cty6.jpg')} style={{height:'100%',width:'100%',resizeMode:'cover'}}/>
      </View>
      </View>
      </View>
      <Footer/>
